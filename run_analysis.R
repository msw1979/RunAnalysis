...
data1 <- cbind(subject, set.mean.std, label) ## merge the data in one table
...
data1.mean <- dcast(data1.melted, subject + activity ~ variable, mean) 

## Write out the mean data to a file
